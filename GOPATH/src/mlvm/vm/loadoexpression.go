...
func TestCallfunc(r *Memoryspace) {
	r.Space[0][0] = &mirror.Atom{Type: "op", Operator: "go"} //go
	r.Space[0][1] = &mirror.Atom{Type: "point", Offset_y: 8, Offset_x: 2}

	r.Space[1][0] = &mirror.Atom{Type: "func", Size_y: 7, Size_x: 4, Name: "addrex"} //func addr
	r.Space[3][0] = &mirror.Atom{Type: "point", Offset_y: 3, Offset_x: 2}            //first op pisition

	r.Space[4][1] = &mirror.Atom{Type: "point", Offset_y: -3, Offset_x: -1} //arg 0
	r.Space[4][2] = &mirror.Atom{Type: "op", Operator: "+"}
	r.Space[4][3] = &mirror.Atom{Type: "point", Offset_y: -2, Offset_x: -1} //arg 1

	r.Space[5][2] = &mirror.Atom{Type: "op", Operator: "="}
	r.Space[5][1] = &mirror.Atom{Type: "rectdata", Offset_x: -2, Offset_y: -1, Rectoffset_x: 0, Rectoffset_y: 0}

	r.Space[8][2] = &mirror.Atom{Type: "op", Operator: "rect"}
	r.Space[8][3] = &mirror.Atom{Type: "rect", Point_y: 0, Point_x: 0, Size_y: 8, Size_x: 5}

	r.Space[9][3] = &mirror.Atom{Type: "int", V_int: 1023}
	r.Space[10][3] = &mirror.Atom{Type: "int", V_int: 231}

	r.Space[9][2] = &mirror.Atom{Type: "op", Operator: "call"}                                   //call
	r.Space[10][2] = &mirror.Atom{Type: "point", Point_y: 1, Point_x: 0}                         //func point
	r.Space[11][2] = &mirror.Atom{Type: "rect", Offset_y: 0, Offset_x: 1, Size_x: 1, Size_y: 2}  //arg rect
	r.Space[12][2] = &mirror.Atom{Type: "rect", Offset_y: 0, Offset_x: -1, Size_x: 1, Size_y: 2} //result rect
