...
func TestExpression_goto(r *Memoryspace, start mirror.Atom) {
	...
	r.Space[start.Point_y][start.Point_x+1] = &mirror.Atom{Type: "point", Point_y: 1, Point_x: 1}
	r.Space[start.Point_y+1][start.Point_x+1] = &mirror.Atom{Type: "op", Operator: "*"}
	r.Space[start.Point_y+1][start.Point_x] = &mirror.Atom{Type: "int", V_int: 1321}
	r.Space[start.Point_y+1][start.Point_x+2] = &mirror.Atom{Type: "int", V_int: 124}
